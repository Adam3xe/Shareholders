...
sponsors = [
    ...
    Apartment("sponsor", "1B", shares=1010),
...
shareholders = [
    ...
    Apartment("shareholder", "1D", shares=510),
    ...
    Apartment("shareholder", "1I", shares=560),
    ...
    Apartment("shareholder", "3I", shares=720),
    ...
    Apartment("shareholder", "6I", shares=1020),
    ...
    Apartment("shareholder", "7I", shares=1100),
